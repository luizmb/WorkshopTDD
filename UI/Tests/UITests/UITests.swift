...
let expectedAlbumListViewState = [
    AlbumListViewModel.ViewState.AlbumCellViewState(id: "1463706038", name: "We Are Not Your Kind", artist: "Slipknot", imageURL: URL(string: "https://is5-ssl.mzstatic.com/image/thumb/Music123/v4/2b/4d/97/2b4d97a1-d445-c0f9-6f95-f602392ec362/016861741006.jpg/128x128bb.jpeg")!, image: nil),
    AlbumListViewModel.ViewState.AlbumCellViewState(id: "1440833237", name: "Metallica", artist: "Metallica", imageURL: URL(string: "https://is1-ssl.mzstatic.com/image/thumb/Music118/v4/65/30/cd/6530cd17-9970-2af8-58eb-e994c0abf73c/00602547331366.rgb.jpg/128x128bb.jpeg")!, image: nil),
    AlbumListViewModel.ViewState.AlbumCellViewState(id: "981156807", name: "Rock In Rio (Live)", artist: "Iron Maiden", imageURL: URL(string: "https://is5-ssl.mzstatic.com/image/thumb/Music3/v4/ce/63/08/ce63083d-5342-312a-2611-dc9bd6ed72c9/825646128266.jpg//128x128bb.jpeg")!, image: nil)
]
